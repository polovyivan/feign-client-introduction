package com.polovyi.ivan.example_4_1;
...
public class Main {
    ...
    public static void main(String[] args) {
        CustomerAppClientExample4_1 client = Feign.builder()
                ...
                .target(CustomerAppClientExample4_1.class,
                        "http://localhost:8001/spring-customer-app");

        String returnFromTest = client.test();
        System.out.println("returnFromTest = " + returnFromTest);
